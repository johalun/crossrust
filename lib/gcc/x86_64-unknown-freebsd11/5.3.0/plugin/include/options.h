...
enum opt_code
{
  ...
  OPT_Z = 443,                               /* -Z */
  OPT_ansi = 444,                            /* -ansi */
  OPT_assert = 445,                          /* -assert */
  OPT_assert_ = 446,                         /* -assert= */
  OPT_aux_info = 447,                        /* -aux-info */
  /* OPT_aux_info_ = 448, */                 /* -aux-info= */
  OPT_auxbase = 449,                         /* -auxbase */
  OPT_auxbase_strip = 450,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 451, */             /* -bootclasspath */
  OPT_c = 452,                               /* -c */
  /* OPT_classpath = 453, */                 /* -classpath */
  OPT_coverage = 454,                        /* -coverage */
  OPT_cpp = 455,                             /* -cpp */
  OPT_cpp_ = 456,                            /* -cpp= */
  OPT_d = 457,                               /* -d */
  OPT_defsym = 458,                          /* -defsym */
  OPT_defsym_ = 459,                         /* -defsym= */
  OPT_dumpbase = 460,                        /* -dumpbase */
  OPT_dumpdir = 461,                         /* -dumpdir */
  OPT_dumpmachine = 462,                     /* -dumpmachine */
  OPT_dumpspecs = 463,                       /* -dumpspecs */
  OPT_dumpversion = 464,                     /* -dumpversion */
  OPT_e = 465,                               /* -e */
  /* OPT_encoding = 466, */                  /* -encoding */
  OPT_export_dynamic = 467,                  /* -export-dynamic */
  OPT_extdirs = 468,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 469, */               /* -fCLASSPATH= */
  OPT_fPIC = 470,                            /* -fPIC */
  OPT_fPIE = 471,                            /* -fPIE */
  OPT_fRTS_ = 472,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 473,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 474,                   /* -fabi-version= */
  OPT_faccess_control = 475,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 476,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 477,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 478,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 479,                  /* -falign-commons */
  OPT_falign_functions = 480,                /* -falign-functions */
  OPT_falign_functions_ = 481,               /* -falign-functions= */
  OPT_falign_jumps = 482,                    /* -falign-jumps */
  OPT_falign_jumps_ = 483,                   /* -falign-jumps= */
  OPT_falign_labels = 484,                   /* -falign-labels */
  OPT_falign_labels_ = 485,                  /* -falign-labels= */
  OPT_falign_loops = 486,                    /* -falign-loops */
  OPT_falign_loops_ = 487,                   /* -falign-loops= */
  OPT_fall_intrinsics = 488,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 489, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 490,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 491,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 492, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 493, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 494, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 495, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 496, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 497,            /* -fasan-shadow-offset= */
  OPT_fasm = 498,                            /* -fasm */
  OPT_fassert = 499,                         /* -fassert */
  OPT_fassociative_math = 500,               /* -fassociative-math */
  OPT_fassume_compiled = 501,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 502,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 503,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 504,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 505,                   /* -fauto-profile */
  OPT_fauto_profile_ = 506,                  /* -fauto-profile= */
  OPT_fautomatic = 507,                      /* -fautomatic */
  OPT_faux_classpath = 508,                  /* -faux-classpath */
  OPT_fbackslash = 509,                      /* -fbackslash */
  OPT_fbacktrace = 510,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 511,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 512,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 513,              /* -fbootstrap-classes */
  OPT_fbounds_check = 514,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 515,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 516,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 517,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 518,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 519,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 520,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 521,                        /* -fbuiltin */
  OPT_fbuiltin_ = 522,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 523,                    /* -fcall-saved- */
  OPT_fcall_used_ = 524,                     /* -fcall-used- */
  OPT_fcaller_saves = 525,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 526,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 527,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 528,                /* -fcheck-data-deps */
  OPT_fcheck_new = 529,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 530,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 531,               /* -fcheck-references */
  OPT_fcheck_ = 532,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 533,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 534,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 535,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 536,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 537,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 538,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 539,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 540, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 541,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 542,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 543,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 544, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 545,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 546,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 547,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 548,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 549,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 550,                       /* -fcilkplus */
  OPT_fclasspath_ = 551,                     /* -fclasspath= */
  OPT_fcoarray_ = 552,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 553,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 554,                         /* -fcommon */
  OPT_fcompare_debug = 555,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 556,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 557,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 558,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 559,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 560,                  /* -fcond-mismatch */
  OPT_fconserve_space = 561,                 /* -fconserve-space */
  OPT_fconserve_stack = 562,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 563,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 564,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 565,                       /* -fconvert= */
  OPT_fcprop_registers = 566,                /* -fcprop-registers */
  OPT_fcray_pointer = 567,                   /* -fcray-pointer */
  OPT_fcrossjumping = 568,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 569,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 570, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 571,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 572,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 573,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 574,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 575,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 576,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 577,                       /* -fdbg-cnt= */
  OPT_fdce = 578,                            /* -fdce */
  OPT_fdebug_cpp = 579,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 580,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 581,            /* -fdebug-types-section */
  ...
  OPT_fdiagnostics_show_caret = 597,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 598,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 599,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 600,                /* -fdirectives-only */
  OPT_fdisable_ = 601,                       /* -fdisable- */
  OPT_fdisable_assertions = 602,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 603,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 604,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 605,         /* -fdollars-in-identifiers */
  OPT_fdse = 606,                            /* -fdse */
  OPT_fdump_ = 607,                          /* -fdump- */
  OPT_fdump_ada_spec = 608,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 609,             /* -fdump-ada-spec-slim */
  ...
  OPT_fdump_go_spec_ = 615,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 616,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 617, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 618,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 619,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 620,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 621,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 622,                 /* -fearly-inlining */
  OPT_felide_constructors = 623,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 624,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 625, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 626,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 627,        /* -femit-class-debug-always */
  OPT_femit_class_file = 628,                /* -femit-class-file */
  OPT_femit_class_files = 629,               /* -femit-class-files */
  ...
  OPT_fenable_assertions = 634,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 635,             /* -fenable-assertions= */
  OPT_fencoding_ = 636,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 637,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 638, */           /* -fenum-int-equiv */
  OPT_fexceptions = 639,                     /* -fexceptions */
  OPT_fexcess_precision_ = 640,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 641,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 642,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 643,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 644,                       /* -fextdirs= */
  OPT_fextended_identifiers = 645,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 646,                /* -fextern-tls-init */
  OPT_fexternal_blas = 647,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 648, */       /* -fexternal-templates */
  OPT_ff2c = 649,                            /* -ff2c */
  OPT_ffast_math = 650,                      /* -ffast-math */
  OPT_ffat_lto_objects = 651,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 652,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 653,               /* -ffinite-math-only */
  OPT_ffixed_ = 654,                         /* -ffixed- */
  OPT_ffixed_form = 655,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 656,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 657,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 658,                    /* -ffloat-store */
  OPT_ffor_scope = 659,                      /* -ffor-scope */
  /* OPT_fforce_addr = 660, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 661,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 662,              /* -fforward-propagate */
  OPT_ffp_contract_ = 663,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 664,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 665,                      /* -ffpe-trap= */
  OPT_ffree_form = 666,                      /* -ffree-form */
  OPT_ffree_line_length_ = 667,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 668,          /* -ffree-line-length-none */
  OPT_ffreestanding = 669,                   /* -ffreestanding */
  OPT_ffriend_injection = 670,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 671,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 672,                   /* -ffunction-cse */
  OPT_ffunction_sections = 673,              /* -ffunction-sections */
  OPT_fgcse = 674,                           /* -fgcse */
  OPT_fgcse_after_reload = 675,              /* -fgcse-after-reload */
  OPT_fgcse_las = 676,                       /* -fgcse-las */
  OPT_fgcse_lm = 677,                        /* -fgcse-lm */
  OPT_fgcse_sm = 678,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 679,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 680,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 681,                         /* -fgnu-tm */
  OPT_fgnu_unique = 682,                     /* -fgnu-unique */
  ...
  OPT_findirect_classes = 710,               /* -findirect-classes */
  OPT_findirect_dispatch = 711,              /* -findirect-dispatch */
  OPT_findirect_inlining = 712,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 713,         /* -finhibit-size-directive */
  OPT_finit_character_ = 714,                /* -finit-character= */
  ...
  OPT_fipa_cp = 733,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 734,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 735,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 736,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 737,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 738,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 739, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 740,                    /* -fipa-profile */
  OPT_fipa_pta = 741,                        /* -fipa-pta */
  OPT_fipa_pure_const = 742,                 /* -fipa-pure-const */
  OPT_fipa_ra = 743,                         /* -fipa-ra */
  OPT_fipa_reference = 744,                  /* -fipa-reference */
  OPT_fipa_sra = 745,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 746, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 747,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 748,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 749,              /* -fira-loop-pressure */
  OPT_fira_region_ = 750,                    /* -fira-region= */
  OPT_fira_share_save_slots = 751,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 752,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 753,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 754,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 755,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 756,               /* -fivar-visibility= */
  OPT_fivopts = 757,                         /* -fivopts */
  OPT_fjni = 758,                            /* -fjni */
  OPT_fjump_tables = 759,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 760,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 761,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 762,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 763, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 764,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 765,             /* -fleading-underscore */
  OPT_flifetime_dse = 766,                   /* -flifetime-dse */
  ...
  /* OPT_fno_vect_cost_model = 812, */       /* -fno-vect-cost-model */
  ...
  OPT_foptimize_static_class_initialization = 836,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 837,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 838, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 839,              /* -foutput-class-dir= */
  ...
  OPT_fprofile_use = 870,                    /* -fprofile-use */
  OPT_fprofile_use_ = 871,                   /* -fprofile-use= */
  OPT_fprofile_values = 872,                 /* -fprofile-values */
  OPT_fprotect_parens = 873,                 /* -fprotect-parens */
  OPT_frandom_seed = 874,                    /* -frandom-seed */
  OPT_frandom_seed_ = 875,                   /* -frandom-seed= */
  OPT_frange_check = 876,                    /* -frange-check */
  OPT_freal_4_real_10 = 877,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 878,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 879,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 880,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 881,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 882,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 883,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 884,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 885,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 886,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 887,                /* -frecord-marker=8 */
  OPT_frecursive = 888,                      /* -frecursive */
  OPT_freduced_reflection = 889,             /* -freduced-reflection */
  OPT_free = 890,                            /* -free */
  ...
  OPT_freorder_blocks_and_partition = 895,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 896,              /* -freorder-functions */
  OPT_frepack_arrays = 897,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 898,           /* -freplace-objc-classes */
  OPT_frepo = 899,                           /* -frepo */
  OPT_freport_bug = 900,                     /* -freport-bug */
  OPT_frequire_return_statement = 901,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 902,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 903, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 904,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 905,                    /* -fresolution= */
  OPT_frounding_math = 906,                  /* -frounding-math */
  OPT_frtti = 907,                           /* -frtti */
  OPT_fsanitize_recover = 908,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 909,              /* -fsanitize-recover= */
  OPT_fsanitize_undefined_trap_on_error = 910,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 911,                      /* -fsanitize= */
  OPT_fsaw_java_file = 912,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 913,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 914,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 915,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 916,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 917,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 918,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 919,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 920,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 921,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 922,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 923,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 924,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 925,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 926,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 927,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 928,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 929,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 930, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 931,                /* -fschedule-fusion */
  OPT_fschedule_insns = 932,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 933,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 934,              /* -fsecond-underscore */
  OPT_fsection_anchors = 935,                /* -fsection-anchors */
  /* OPT_fsee = 936, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 937,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 938,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 939, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 940,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 941,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 942,         /* -fsemantic-interposition */
  OPT_fshort_double = 943,                   /* -fshort-double */
  OPT_fshort_enums = 944,                    /* -fshort-enums */
  OPT_fshort_wchar = 945,                    /* -fshort-wchar */
  OPT_fshow_column = 946,                    /* -fshow-column */
  OPT_fshrink_wrap = 947,                    /* -fshrink-wrap */
  OPT_fsign_zero = 948,                      /* -fsign-zero */
  OPT_fsignaling_nans = 949,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 950,               /* -fsigned-bitfields */
  OPT_fsigned_char = 951,                    /* -fsigned-char */
  OPT_fsigned_zeros = 952,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 953,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 954,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 955,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 956,               /* -fsource-filename= */
  OPT_fsource_ = 957,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 958,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 959,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 960,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 961, */                 /* -fsquangle */
  OPT_fssa_phiopt = 962,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 963,                   /* -fstack-arrays */
  /* OPT_fstack_check = 964, */              /* -fstack-check */
  OPT_fstack_check_ = 965,                   /* -fstack-check= */
  OPT_fstack_limit = 966,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 967,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 968,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 969,                /* -fstack-protector */
  OPT_fstack_protector_all = 970,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 971,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 972,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 973,                   /* -fstack-reuse= */
  OPT_fstack_usage = 974,                    /* -fstack-usage */
  OPT_fstats = 975,                          /* -fstats */
  OPT_fstdarg_opt = 976,                     /* -fstdarg-opt */
  OPT_fstore_check = 977,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 978, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 979,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 980,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 981,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 982, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 983,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 984,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 985,                    /* -fsyntax-only */
  OPT_ftabstop_ = 986,                       /* -ftabstop= */
  /* OPT_ftarget_help = 987, */              /* -ftarget-help */
  OPT_ftarget_ = 988,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 989,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 990, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 991,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 992,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 993, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 994,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 995,             /* -fthreadsafe-statics */
  OPT_ftime_report = 996,                    /* -ftime-report */
  OPT_ftls_model_ = 997,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 998,               /* -ftoplevel-reorder */
  OPT_ftracer = 999,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 1000,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1001,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1002,                 /* -ftrapping-math */
  OPT_ftrapv = 1003,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1004,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1005,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1006,                      /* -ftree-ccp */
  OPT_ftree_ch = 1007,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1008,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1009,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1010,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1011,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1012,                   /* -ftree-cselim */
  OPT_ftree_dce = 1013,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1014,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1015,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1016,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1017,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1018, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1019,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1020,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1021,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1022,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1023,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1024, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1025,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1026,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1027,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1028,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1029,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1030,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1031,                      /* -ftree-pre */
  OPT_ftree_pta = 1032,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1033,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1034, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1035,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1036,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1037,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1038,                     /* -ftree-slsr */
  OPT_ftree_sra = 1039,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1040, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1041, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1042,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1043,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1044,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1045, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1046,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1047, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1048,                      /* -ftree-vrp */
  OPT_funderscoring = 1049,                  /* -funderscoring */
  OPT_funit_at_a_time = 1050,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1051,              /* -funroll-all-loops */
  OPT_funroll_loops = 1052,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1053,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1054,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1055,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1056,                 /* -funsigned-char */
  OPT_funswitch_loops = 1057,                /* -funswitch-loops */
  OPT_funwind_tables = 1058,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1059,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1060,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1061,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1062,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1063,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1064,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1065,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1066,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1067,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1068,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1069,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1070,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1071,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1072, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1073,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1074,                   /* -fverbose-asm */
  /* OPT_fversion = 1075, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1076,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1077,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1078,                   /* -fvisibility= */
  OPT_fvpt = 1079,                           /* -fvpt */
  /* OPT_fvtable_gc = 1080, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1081, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1082,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1083,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1084,                     /* -fvtv-debug */
  OPT_fweak = 1085,                          /* -fweak */
  OPT_fweb = 1086,                           /* -fweb */
  /* OPT_fwhole_file = 1087, */              /* -fwhole-file */
  OPT_fwhole_program = 1088,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1089,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1090,             /* -fworking-directory */
  OPT_fwpa = 1091,                           /* -fwpa */
  OPT_fwpa_ = 1092,                          /* -fwpa= */
  OPT_fwrapv = 1093,                         /* -fwrapv */
  /* OPT_fxref = 1094, */                    /* -fxref */
  /* OPT_fzee = 1095, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1096,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1097,                     /* -fzero-link */
  OPT_g = 1098,                              /* -g */
  OPT_gant = 1099,                           /* -gant */
  OPT_gcoff = 1100,                          /* -gcoff */
  OPT_gdwarf = 1101,                         /* -gdwarf */
  OPT_gdwarf_ = 1102,                        /* -gdwarf- */
  OPT_gen_decls = 1103,                      /* -gen-decls */
  OPT_ggdb = 1104,                           /* -ggdb */
  OPT_ggnu_pubnames = 1105,                  /* -ggnu-pubnames */
  OPT_gnat = 1106,                           /* -gnat */
  OPT_gnatO = 1107,                          /* -gnatO */
  OPT_gno_pubnames = 1108,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1109,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1110,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1111,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1112,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1113,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1114,                   /* -gsplit-dwarf */
  OPT_gstabs = 1115,                         /* -gstabs */
  OPT_gstabs_ = 1116,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1117,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1118,                        /* -gtoggle */
  OPT_gvms = 1119,                           /* -gvms */
  OPT_gxcoff = 1120,                         /* -gxcoff */
  OPT_gxcoff_ = 1121,                        /* -gxcoff+ */
  OPT_gz = 1122,                             /* -gz */
  OPT_gz_ = 1123,                            /* -gz= */
  OPT_h = 1124,                              /* -h */
  OPT_idirafter = 1125,                      /* -idirafter */
  OPT_imacros = 1126,                        /* -imacros */
  OPT_imultiarch = 1127,                     /* -imultiarch */
  OPT_imultilib = 1128,                      /* -imultilib */
  OPT_include = 1129,                        /* -include */
  OPT_iplugindir_ = 1130,                    /* -iplugindir= */
  OPT_iprefix = 1131,                        /* -iprefix */
  OPT_iquote = 1132,                         /* -iquote */
  ...
  OPT_m128bit_long_double = 1140,            /* -m128bit-long-double */
  OPT_m16 = 1141,                            /* -m16 */
  OPT_m32 = 1142,                            /* -m32 */
  OPT_m3dnow = 1143,                         /* -m3dnow */
  OPT_m3dnowa = 1144,                        /* -m3dnowa */
  OPT_m64 = 1145,                            /* -m64 */
  OPT_m80387 = 1146,                         /* -m80387 */
  OPT_m8bit_idiv = 1147,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1148,             /* -m96bit-long-double */
  OPT_mabi_ = 1149,                          /* -mabi= */
  OPT_mabm = 1150,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1151,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1152,                 /* -maddress-mode= */
  OPT_madx = 1153,                           /* -madx */
  OPT_maes = 1154,                           /* -maes */
  OPT_malign_data_ = 1155,                   /* -malign-data= */
  OPT_malign_double = 1156,                  /* -malign-double */
  OPT_malign_functions_ = 1157,              /* -malign-functions= */
  OPT_malign_jumps_ = 1158,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1159,                  /* -malign-loops= */
  OPT_malign_stringops = 1160,               /* -malign-stringops */
  OPT_march_ = 1161,                         /* -march= */
  OPT_masm_ = 1162,                          /* -masm= */
  OPT_mavx = 1163,                           /* -mavx */
  OPT_mavx2 = 1164,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1165,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1166,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1167,                      /* -mavx512bw */
  OPT_mavx512cd = 1168,                      /* -mavx512cd */
  OPT_mavx512dq = 1169,                      /* -mavx512dq */
  OPT_mavx512er = 1170,                      /* -mavx512er */
  OPT_mavx512f = 1171,                       /* -mavx512f */
  OPT_mavx512ifma = 1172,                    /* -mavx512ifma */
  OPT_mavx512pf = 1173,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1174,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1175,                      /* -mavx512vl */
  OPT_mbmi = 1176,                           /* -mbmi */
  ...
  OPT_mveclibabi_ = 1271,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1272,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1273,                    /* -mvzeroupper */
  OPT_mx32 = 1274,                           /* -mx32 */
  OPT_mxop = 1275,                           /* -mxop */
  OPT_mxsave = 1276,                         /* -mxsave */
  OPT_mxsavec = 1277,                        /* -mxsavec */
  OPT_mxsaveopt = 1278,                      /* -mxsaveopt */
  OPT_mxsaves = 1279,                        /* -mxsaves */
  OPT_n = 1280,                              /* -n */
  OPT_no_canonical_prefixes = 1281,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1282,              /* -no-integrated-cpp */
  OPT_nocpp = 1283,                          /* -nocpp */
  OPT_nodefaultlibs = 1284,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1285,                   /* -nostartfiles */
  OPT_nostdinc = 1286,                       /* -nostdinc */
  OPT_nostdinc__ = 1287,                     /* -nostdinc++ */
  OPT_nostdlib = 1288,                       /* -nostdlib */
  OPT_o = 1289,                              /* -o */
  OPT_p = 1290,                              /* -p */
  OPT_pass_exit_codes = 1291,                /* -pass-exit-codes */
  /* OPT_pedantic = 1292, */                 /* -pedantic */
  OPT_pedantic_errors = 1293,                /* -pedantic-errors */
  OPT_pg = 1294,                             /* -pg */
  OPT_pie = 1295,                            /* -pie */
  OPT_pipe = 1296,                           /* -pipe */
  OPT_posix = 1297,                          /* -posix */
  OPT_print_file_name_ = 1298,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1299,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1300,          /* -print-multi-directory */
  OPT_print_multi_lib = 1301,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1302,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1303,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1304,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1305,               /* -print-prog-name= */
  OPT_print_search_dirs = 1306,              /* -print-search-dirs */
  OPT_print_sysroot = 1307,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1308,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1309,                        /* -profile */
  OPT_pthread = 1310,                        /* -pthread */
  OPT_quiet = 1311,                          /* -quiet */
  OPT_r = 1312,                              /* -r */
  OPT_rdynamic = 1313,                       /* -rdynamic */
  OPT_remap = 1314,                          /* -remap */
  OPT_rpath = 1315,                          /* -rpath */
  OPT_rpath_link = 1316,                     /* -rpath-link */
  OPT_rpath_link_ = 1317,                    /* -rpath-link= */
  OPT_rpath_ = 1318,                         /* -rpath= */
  OPT_s = 1319,                              /* -s */
  ...
  OPT_soname = 1325,                         /* -soname */
  OPT_soname_ = 1326,                        /* -soname= */
